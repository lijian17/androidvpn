...
public class Packet {
	...
	public String toString() {
		...
		sb.append(", payloadSize=").append(
				backingBuffer.limit() - backingBuffer.position());
		sb.append('}');
		return sb.toString();
	}
	...
	private void updateTCPChecksum(int payloadSize) {
		...
		ByteBuffer buffer = ByteBuffer.wrap(ip4Header.sourceAddress
				.getAddress());
		sum = BitUtils.getUnsignedShort(buffer.getShort())
	...
	public static class IP4Header {
		...
		public String toString() {
			...
			sb.append(", identificationAndFlagsAndFragmentOffset=").append(
					identificationAndFlagsAndFragmentOffset);
			sb.append(", TTL=").append(TTL);
			sb.append(", protocol=").append(protocolNum).append(":")
					.append(protocol);
			sb.append(", headerChecksum=").append(headerChecksum);
			sb.append(", sourceAddress=")
					.append(sourceAddress.getHostAddress());
			sb.append(", destinationAddress=").append(
	...
	public static class TCPHeader {
		...
		private TCPHeader(ByteBuffer buffer) {
			...
			this.acknowledgementNumber = BitUtils.getUnsignedInt(buffer
					.getInt());
