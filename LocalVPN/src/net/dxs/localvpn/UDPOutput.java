...
public class UDPOutput implements Runnable {
	...
	private LRUCache<String, DatagramChannel> channelCache = new LRUCache<String, DatagramChannel>(
			MAX_CACHE_SIZE,
		...
		try {
			...
			while (true) {
				...
				if (outputChannel == null) {
					...
					try {
						outputChannel.connect(new InetSocketAddress(
	...
	private void closeAll() {
		Iterator<Map.Entry<String, DatagramChannel>> it = channelCache
				.entrySet().iterator();
		while (it.hasNext()) {
