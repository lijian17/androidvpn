...
public class TCB {
	...
	public enum TCBStatus {
		SYN_SENT, SYN_RECEIVED, ESTABLISHED, CLOSE_WAIT, LAST_ACK,
	}
	...
	private static LRUCache<String, TCB> tcbCache = new LRUCache<String, TCB>(
			MAX_CACHE_SIZE, new LRUCache.CleanupCallback<String, TCB>() {
				@Override
	...
	public TCB(String ipAndPort, long mySequenceNum, long theirSequenceNum,
			long myAcknowledgementNum, long theirAcknowledgementNum,
	...
	public static void closeAll() {
		synchronized (tcbCache) {
			Iterator<Map.Entry<String, TCB>> it = tcbCache.entrySet()
					.iterator();
			while (it.hasNext()) {
