			...
			public void onClick(View v) {
				...
				new AsyncHttpClient().get(url, new TextHttpResponseHandler() {
					...
					public void onSuccess(int statusCode, Header[] headers,
						...
						Toast.makeText(LocalVPN.this, "baidu-onSuccess:" + responseString, Toast.LENGTH_SHORT).show();
					}
					
					@Override
					public void onFailure(int statusCode, Header[] headers,
							String responseString, Throwable throwable) {
						Toast.makeText(LocalVPN.this, "baidu-onFailure:" + responseString + "-statusCode:" + statusCode + "-throwable:" + throwable.getMessage(), Toast.LENGTH_SHORT).show();
					}
				});
			}
		});
    	cpsino.setOnClickListener(new OnClickListener() {
    		...
    		public void onClick(View v) {
				...
				new AsyncHttpClient().get(url, new TextHttpResponseHandler() {
					...
					public void onSuccess(int statusCode, Header[] headers,
							String responseString) {
						Toast.makeText(LocalVPN.this, "cpsino-onSuccess:" + responseString, Toast.LENGTH_SHORT).show();
					}
					
					@Override
					public void onFailure(int statusCode, Header[] headers,
							String responseString, Throwable throwable) {
						Toast.makeText(LocalVPN.this, "cpsino-onFailure:" + responseString + "-statusCode:" + statusCode + "-throwable:" + throwable.getMessage(), Toast.LENGTH_SHORT).show();
					}
				});
    		}
    	});
